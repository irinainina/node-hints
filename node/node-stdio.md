...
```
Метод `stdout.write()` принимает в качестве аргумента строку и выводит её в консоль. В отличие от `console.log()` не добавляет автоматический перенос строки, при необходимости его вручную `\n`.
